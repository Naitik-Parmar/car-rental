...
//           <div>
//             {booking.id} - {booking.bookCarStatus}
//           </div>
//           {booking.bookCarStatus === 'PENDING' && (
//             <div>
//               <button onClick={() => changeBookingStatus(booking.id, 'Approve')}>
//                 Approve
//               </button>
...
// import React, { useEffect, useState } from 'react';
// import axios from 'axios';
// import './bookings.css'; // Ensure this CSS file exists and is correctly scoped to this component

// const Bookings = () => {
//   const [bookings, setBookings] = useState([]);
//   const [isSpinning, setIsSpinning] = useState(false);

//   // Log to check if the component is mounting
...
//       {bookings.map(booking => (
//         <div key={booking.id} className="booking-item">
//           <div>{booking.id} - {booking.bookCarStatus}</div>
//           {booking.bookCarStatus === 'PENDING' && (
//             <div>
//               <button onClick={() => changeBookingStatus(booking.id, 'Approve')}>
//                 Approve
